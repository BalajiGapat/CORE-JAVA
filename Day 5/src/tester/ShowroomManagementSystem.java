...
// chasisNo,  vehicleColor,  netPrice,  manufactureDate,  company
	public static void main(String[] args) {
		try (Scanner sc = new Scanner(System.in)) {

			/*
			 * List<Vehicle> vList=new ArrayList<>(); 
			 * vList.add(new Vehicle("abc-123", Color.RED, 12345, LocalDate.parse("2022-11-11"), "honda"));
			 * System.out.println("for test : "+vList);
			 * 
			 */
